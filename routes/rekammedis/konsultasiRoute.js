...
router.get('/masuk', asyncHandler(konsultasiController.getIncomingConsultations));
router.get('/keluar', asyncHandler(konsultasiController.getOutgoingConsultations));
router.get('/dokter-list', asyncHandler(konsultasiController.getDoctorsList));
router.post(
  '/',
